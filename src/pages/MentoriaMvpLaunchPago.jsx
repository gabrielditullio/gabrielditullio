...
/* ============================================================
   BRIEFING — LANÇAMENTO MENTORIA MVP · WORKSHOP JUNHO/2026
   ────────────────────────────────────────────────────────────
...
:root {
  /* Cor — paleta OKLCH não-óbvia (terracota + verde-petróleo) */
  --bg:           oklch(0.165 0.014 50);
  --bg-elev:     oklch(0.205 0.013 55);
  --surface:      oklch(0.235 0.012 58);
  --surface-2:    oklch(0.275 0.011 60);
  --ink:          oklch(0.965 0.014 80);
  --ink-soft:     oklch(0.840 0.018 75);
  --ink-muted:    oklch(0.605 0.014 68);
  --ink-faint:    oklch(0.420 0.012 60);

  --primary:      oklch(0.785 0.155 55);   /* terracota queimada */
  --primary-deep: oklch(0.560 0.140 50);
  --primary-soft: oklch(0.785 0.155 55 / 0.13);
  --primary-glow: oklch(0.785 0.155 55 / 0.30);

  --secondary:    oklch(0.640 0.110 195);  /* verde-petróleo */
  --success:      oklch(0.715 0.130 145);
  --warning:      oklch(0.770 0.155 65);
  --critical:     oklch(0.625 0.195 25);

  --hairline:        oklch(0.965 0.014 80 / 0.09);
  --hairline-strong: oklch(0.965 0.014 80 / 0.18);
}
}
...
html {
  ...
  font-size: clamp(14.5px, 0.95vw + 0.4rem, 17px);
...
table.t tbody tr:hover {
  background: oklch(0.785 0.155 55 / 0.04);
}
