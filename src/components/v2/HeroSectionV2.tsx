...
const badges = [{
  icon: "⚡",
  text: "Resultados em 30 dias"
}, {
  icon: "💰",
  text: "Retorno médio de 5x sobre o investido"
}, {
  icon: "📍",
  text: "Foco total no seu bairro e região"
}];
const HeroSectionV2 = () => {
      ...
      <div className="container relative z-10 py-20 md:py-0">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          visible: {
            ...
            <motion.p variants={fadeUp} transition={{
            duration: 0.6,
            ease: [0.22, 1, 0.36, 1]
            ...
            ease: [0.22, 1, 0.36, 1]
              ...
              <a href={getWhatsAppLink()} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-cta-gradient text-primary-foreground font-heading font-bold text-lg shadow-cta hover:shadow-cta-hover hover:scale-105 transition-all duration-300 animate-pulse-glow whitespace-nowrap">
                AGENDAR CONSULTORIA
              </a>
            </motion.div>
            ...
            visible: {
              ...
              {badges.map(b => <motion.span key={b.text} variants={fadeUp} transition={{
              duration: 0.4,
              ease: [0.22, 1, 0.36, 1]
          ...
          {/* Photo area */}
          <motion.div initial="hidden" animate="visible" variants={slideInRight} transition={{
          duration: 0.9,
          ease: [0.22, 1, 0.36, 1],
          delay: 0.4
            ...
            <div className="relative z-10 w-full max-w-md">
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden bg-card border border-border shadow-card-glow">
                ...
                <img src={heroPhoto} alt="Gabriel Di Tullio - Gestor de Tráfego" className="w-full h-full object-cover object-top" />
              </div>
              <motion.div initial="hidden" animate="visible" variants={scaleIn} transition={{
              duration: 0.5,
              delay: 1.0,
              ease: [0.22, 1, 0.36, 1]
