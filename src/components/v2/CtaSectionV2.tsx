...
const CtaSectionV2 = () => {
  ...
  return <motion.section ref={ctaRef} id="cta-final" initial="hidden" whileInView="visible" viewport={{
    once: true,
    amount: 0.2
  }} variants={{
    hidden: {},
    visible: {
      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <motion.h2 variants={fadeUp} transition={{
          duration: 0.7,
          ease: [0.22, 1, 0.36, 1]
          ...
          <motion.div variants={scaleIn} transition={{
          duration: 0.5,
          ease: [0.22, 1, 0.36, 1]
        }}>
            <a href={getWhatsAppLink()} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-10 py-5 rounded-full bg-cta-gradient text-primary-foreground font-heading font-bold text-xl shadow-cta hover:shadow-cta-hover hover:scale-105 transition-all duration-300 animate-cta-glow-pulse">
          ...
          visible: {
            ...
            {["⚡ Resposta em até 2 horas", "🔒 Seus dados estão seguros", "✅ 100% gratuito"].map(badge => <motion.span key={badge} variants={fadeUp} transition={{
            duration: 0.4,
            ease: [0.22, 1, 0.36, 1]
